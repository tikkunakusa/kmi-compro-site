...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-100 border-t border-gray-300">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">

        {/* LEFT */}
        <div className="space-y-6">
          <Image src="/images/kmi-footer-icon.png" alt="Konsultan Manajemen Indonesia / KMI Logo" width={300} height={200} className="mt-4 w-auto h-auto max-w-[300px]" />
        </div>
